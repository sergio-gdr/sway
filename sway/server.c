...
bool server_init(struct sway_server *server) {
	...
	server->commit_timing_manager_v1 = wlr_commit_timing_manager_v1_create(server->wl_display, 1);
	wlr_scene_set_commit_timing_manager_v1(root->root_scene, server->commit_timing_manager_v1);
